...
This week we look at Spinoza's view of substance and its connection to one or another variety of the PSR. Among the questions we'll be asking are the following: Does Spinoza endorse a version of the PSR? What role, if any, does it play in his monism argument? How is any version of the PSR related to his overall project in /Ethics/ I?  
...
# Local Variables:
# eval: (with-eval-after-load 'ox-hugo (plist-put org-hugo-citations-plist :bibliography-section-heading ""))
# End:
