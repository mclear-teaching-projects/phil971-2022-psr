...
- [ ] Brief review of last week
   + [ ] Logical form & varieties of PSR
   + [ ] Features of the "reason" or "ground" relation
      * transitive, asymmetric, and irreflexive?
   + [ ] Does Descartes accept the standard form of ground relation?
      - [ ] Is Descartes's conception of God as self-caused a problem for standard form?
   + [ ] Does Descartes's view of universality of PSR_ontic indicate he endorses the universal intelligibility of all things?
- [ ] Overview of Spinoza
   + [ ] Geometric method
   + [ ] Aims of the /Ethics/
      - [ ] The nature of God, the relation of human being to God, and the conditions for a good human life
      - [ ] Note that we won't in any sense discuss all (or even a majority) of the issues raised by the first two books
      - [ ] Overview of E1-2
