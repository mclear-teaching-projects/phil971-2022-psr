...
The sense of &ldquo;determination&rdquo; which people are concerned with is often termed
...
On this view, every action has a determining ground, but every action is not thereby absolutely necessary because the series of determining grounds is not itself logically necessary, and thus in that sense could have been different (i.e. there is no contradiction in positing a different series).
...
[^fn:5]: For a defense of Leibniz&rsquo;s view of freedom and contingency see
    (<a href="#citeproc_bib_item_5">Jorati 2017, chap. 5</a>). For criticism (either of the overall theory with
    respect to freedom, or the particulars of Leibniz&rsquo;s &ldquo;infinite analysis&rdquo; theory
    of contingency) see (<a href="#citeproc_bib_item_3">Carriero 1991, 83</a>; chaps <a href="#citeproc_bib_item_1">Adams 1994, 1–2</a>; <a href="#citeproc_bib_item_4">Carriero, Mugnai, and Garber 1996, 63</a> f; <a href="#citeproc_bib_item_9">Riley 1996, 85–88</a>; <a href="#citeproc_bib_item_2">Bennett 2001, chap. 17</a>).
